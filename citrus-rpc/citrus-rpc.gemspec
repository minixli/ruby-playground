...
Gem::Specification.new do |spec|
  ...
  spec.description = %q{citrus-rpc is a simple clone of pomelo-rpc, it provides the infrastructure of RPC between multi-server processes}
  spec.summary     = %q{pomelo-rpc clone written in Ruby using EventMachine}
  spec.homepage    = 'https://github.com/minixli/ruby-playground/citrus-rpc'
  spec.license     = 'MIT'
